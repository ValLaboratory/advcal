-- 外部キー制約の削除
ALTER TABLE agency_jp DROP FOREIGN KEY fk_agency_jp_agency_id ;
ALTER TABLE routes_jp DROP FOREIGN KEY fk_routes_jp_route_id ;
ALTER TABLE trips DROP FOREIGN KEY fk_trips_route_id ;
ALTER TABLE fare_rules DROP FOREIGN KEY fk_fare_rules_route_id ;
ALTER TABLE frequencies DROP FOREIGN KEY fk_frequencies_trip_id ;
ALTER TABLE trips DROP FOREIGN KEY fk_trips_service_id ;
ALTER TABLE trips DROP FOREIGN KEY fk_trips_office_id ;
ALTER TABLE trips DROP FOREIGN KEY fk_trips_shape_id ;
ALTER TABLE stop_times DROP FOREIGN KEY fk_stop_times_stop_id ;
...
-- 外部制約
ALTER TABLE agency_jp
	ADD CONSTRAINT fk_agency_jp_agency_id
...
-- routes.txtのroute_id
ALTER TABLE routes_jp
	ADD CONSTRAINT fk_routes_jp_route_id
...
-- office_jp.txtのoffice_id
ALTER TABLE trips
	ADD CONSTRAINT fk_trips_office_id
