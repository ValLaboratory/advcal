...
-- 経路情報
CREATE TABLE routes (
	route_id		VARCHAR(64) NOT NULL,		-- 経路ID
	agency_id		VARCHAR(64) NOT NULL,		-- 事業者ID
...
CREATE TABLE calendar (
	service_id	VARCHAR(64) NOT NULL,		-- 運行日ID
...
-- 便情報
CREATE TABLE trips (
	trip_id			VARCHAR(64) NOT NULL,		-- 便ID
	route_id		VARCHAR(64),			-- 経路ID
...
CREATE TABLE office_jp (
	office_id	VARCHAR(64) NOT NULL,		-- 営業所ID
...
-- 停留所・標柱情報
CREATE TABLE stops (
	stop_id			VARCHAR(64) NOT NULL,		-- 停留所・標柱ID
...
CREATE TABLE fare_attributes (
	fare_id			VARCHAR(64) NOT NULL,		-- 運賃ID
...
-- 描画情報
CREATE TABLE shapes (
	shape_id		VARCHAR(64) NOT NULL,		-- 描画ID
